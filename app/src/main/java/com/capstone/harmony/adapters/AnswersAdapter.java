...
public class AnswersAdapter extends RecyclerView.Adapter<AnswersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if(owner_id.equals(FirebaseAuth.getInstance().getCurrentUser().getUid()) || (answer.getUser_id().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()) && (answered_by == null || answered_by.trim().equals("")))) {
