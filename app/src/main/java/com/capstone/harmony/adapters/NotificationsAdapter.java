...
import com.capstone.harmony.models.Notification;
...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        }else if(notification.getBody().toLowerCase().contains("have a community request for")){
            holder.type_image.setImageResource(R.drawable.ic_bubble_chart_black_24dp);
        }else if(notification.getBody().toLowerCase().contains("have reported a post under the community of")){
            holder.type_image.setImageResource(R.drawable.ic_report_black_24dp);
        }else if(notification.getBody().toLowerCase().contains("have reported")){
            holder.type_image.setImageResource(R.drawable.ic_report_black_24dp);
        }else{
